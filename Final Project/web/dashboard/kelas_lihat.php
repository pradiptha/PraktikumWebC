...
$queryKelas = mysqli_query($koneksi, "SELECT * FROM mahasiswa_kelas INNER JOIN kelas ON mahasiswa_kelas.id_kelas=kelas.id_kelas INNER JOIN mahasiswa ON mahasiswa_kelas.id_mahasiswa=mahasiswa.id_mahasiswa WHERE kelas.id_kelas = '$id_kelas'");
$kelas = mysqli_query($koneksi, "SELECT matakuliah FROM kelas INNER JOIN matakuliah ON kelas.id_mk=matakuliah.id_mk WHERE id_kelas = '$id_kelas'");
                ...
                <div class="container-fluid">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="font mt-3 px-4 mb-0">
                            <h4 style="font-weight: 600;">Nama Kelas : <?= $nama['matakuliah']; ?></h4>
                        </div>
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="col-sm-4" style="width: 10%;">NIM</th>
