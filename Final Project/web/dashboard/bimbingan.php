                                    ...
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        foreach ($queryBimbingan as $data) : ?>
                                            ...
                                            <tr>
                                                <td><?= $i++; ?></td>
                                                <?php if ($role == "0") { ?>
                                                    <td><a href="edit_bimbingan.php?id_bimbingan=<?= $data['id_bimbingan']; ?>" class="badge badge-primary ">Edit</a> | <a href="dashboard.php?act=hapusBimbingan&id_bimbingan=<?= $data['id_bimbingan']; ?>" onclick="return confirm('Yakin ingin menghapus?');" class="badge badge-danger ">Hapus</a> </td>
                                                <?php } ?>
                                                <td><?= $data['nim']; ?></td>
                                                <td><?= $data['namamah']; ?></td>
                                                <td><?= $data['namados']; ?></td>
