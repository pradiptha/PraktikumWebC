                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <?php while ($data = mysqli_fetch_assoc($queryMatakuliah)) { ?>
                                        ...
                                        <tr>
                                            <td><?= $i; ?></td>
                                            <?php if ($role == "0") { ?>
                                                <td><a href="" class="badge badge-primary ">Edit</a> | <a href="dashboard.php?act=hapusMatkul&id_mk=<?= $data['id_mk']; ?>" onclick="return confirm('Yakin ingin menghapus?');" class="badge badge-danger ">Hapus</a></td>
                                            <?php } ?>
                                            <td><?= $data['kode_mk']; ?></td>
